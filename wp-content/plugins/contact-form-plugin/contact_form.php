...
if( ! function_exists( 'cntctfrm_settings' ) ) {
	function cntctfrm_settings() {
		...
		$cntctfrm_option_defaults = array(
			...
			'cntctfrm_name_label' 				=> array( 'en' => __( "Ime i prezime:", 'contact_form' ) ),
			'cntctfrm_address_label' 			=> array( 'en' => __( "Address:", 'contact_form' ) ),
			'cntctfrm_email_label' 				=> array( 'en' => __( "Email adresa:", 'contact_form' ) ),		 	
			'cntctfrm_phone_label' 				=> array( 'en' => __( "Phone number:", 'contact_form' ) ),
			'cntctfrm_subject_label' 			=> array( 'en' => __( "Naslov:", 'contact_form' ) ),
			'cntctfrm_message_label' 			=> array( 'en' => __( "Poruka:", 'contact_form' ) ),
			...
			'cntctfrm_submit_label'				=> array( 'en' => __( "Pošalji", 'contact_form' ) ),
			...
			'cntctfrm_email_error' 				=> array( 'en' => __( "Email adresa mora biti validna.", 'contact_form' ) ),
			'cntctfrm_phone_error' 				=> array( 'en' => __( "Phone number is required.", 'contact_form' ) ),
			'cntctfrm_subject_error' 			=> array( 'en' => __( "Naslov je obavezan.", 'contact_form' ) ),
			'cntctfrm_message_error' 			=> array( 'en' => __( "Tekst poruke je obavezan.", 'contact_form' ) ),
			...
			'cntctfrm_form_error'				=> array( 'en' => __( "Uradite naznačene ispravke i pokušajte ponovo.", 'contact_form' ) ),
			'cntctfrm_action_after_send' 		=> 1,
			'cntctfrm_thank_text' 				=> array( 'en' => __( "Hvala Vam što ste nas kontaktirali.", 'contact_form' ) ),
